...
**Question 7 (3 points)** _Create a column in your state food insecurity estimates that converts each state's food insecurity rate to a z score based on the whole population. What is the z score for New Jersey? What does that z score tell you?_
